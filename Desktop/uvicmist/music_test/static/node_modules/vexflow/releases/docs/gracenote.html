...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">GraceNote</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">StaveNote</span> </span>{
  ...
  draw() {
    ...
    <span class="hljs-keyword">const</span> stem_direction = <span class="hljs-keyword">this</span>.getStemDirection();
    ...
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.slash) {
      ...
      <span class="hljs-keyword">let</span> y = <span class="hljs-keyword">this</span>.getYs()[<span class="hljs-number">0</span>] - (<span class="hljs-keyword">this</span>.stem.getHeight() / <span class="hljs-number">2.8</span>);
