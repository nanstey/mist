...
values.</p>
    ...
    <span class="hljs-keyword">const</span> line_ys = [];</pre></div>
        ...
        <p>Iterate through each group string and store it’s y position</p>
          ...
          <div class='highlight'><pre>    strings.forEach((string, index, strings) =&gt; {
...
stem above/below the stave if it’s the top/bottom string</p>
        ...
        <p>Add the sorted y values to the</p>
          ...
          <div class='highlight'><pre>    stem_lines.push(line_ys.sort((a, b) =&gt; a - b));
  });
...
Often used for indicating frets that are being bent to</p>
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-keyword">this</span>.positions.length; ++i) {
      ...
      <span class="hljs-keyword">const</span> glyph = Flow.tabToGlyph(fret);
    ...
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.context) {
      <span class="hljs-keyword">for</span> (i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-keyword">this</span>.glyphs.length; ++i) {
        <span class="hljs-keyword">const</span> text = <span class="hljs-string">''</span> + <span class="hljs-keyword">this</span>.glyphs[i].text;
    ...
    <span class="hljs-keyword">const</span> ys = [];</pre></div>
      ...
      <span class="hljs-keyword">const</span> line = <span class="hljs-keyword">this</span>.positions[i].str;
    ...
    <span class="hljs-keyword">const</span> note_glyph_width = <span class="hljs-keyword">this</span>.glyph.head_width;
...
fret number and the stem</p>
    ...
    <span class="hljs-keyword">const</span> stem_base_y = <span class="hljs-keyword">this</span>.getStemY();
    <span class="hljs-keyword">const</span> stem_top_y = stem_base_y + (Stem.HEIGHT * -<span class="hljs-keyword">this</span>.stem_direction);
    ...
    <span class="hljs-keyword">const</span> render_flag = <span class="hljs-keyword">this</span>.beam == <span class="hljs-literal">null</span> &amp;&amp; render_stem;</pre></div>
      ...
      <span class="hljs-keyword">const</span> flag_y = <span class="hljs-keyword">this</span>.getStemY() - (<span class="hljs-keyword">this</span>.stem.getHeight());
      <span class="hljs-keyword">let</span> flag_code;
    ...
    <span class="hljs-keyword">let</span> stem_x = <span class="hljs-keyword">this</span>.getStemX();
    ...
    <span class="hljs-keyword">if</span> (draw_stem &amp;&amp; stem_through) {
      ...
      <span class="hljs-keyword">const</span> strings_used = <span class="hljs-keyword">this</span>.positions.map(position =&gt; position.str);

      <span class="hljs-keyword">const</span> unused_strings = getUnusedStringGroups(total_lines, strings_used);
      <span class="hljs-keyword">const</span> stem_lines = getPartialStemLines(stem_y, unused_strings,
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-keyword">this</span>.positions.length; ++i) {
      ...
      <span class="hljs-keyword">const</span> glyph = <span class="hljs-keyword">this</span>.glyphs[i];</pre></div>
        ...
        <p>Center the fret text beneath the notation note head</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">const</span> note_glyph_width = <span class="hljs-keyword">this</span>.glyph.head_width;
      <span class="hljs-keyword">const</span> tab_x = x + (note_glyph_width / <span class="hljs-number">2</span>) - (glyph.width / <span class="hljs-number">2</span>);
