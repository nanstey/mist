...
<span class="hljs-keyword">import</span> { Glyph } <span class="hljs-keyword">from</span> <span class="hljs-string">'./glyph'</span>;</pre></div>
        ...
        <p>To enable logging for this class. Set <code>Vex.Flow.Accidental.DEBUG</code> to <code>true</code>.</p>
          ...
          <div class='highlight'><pre><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">L</span>(<span class="hljs-params">...args</span>) </span>{ <span class="hljs-keyword">if</span> (Accidental.DEBUG) Vex.L(<span class="hljs-string">'Vex.Flow.Accidental'</span>, args); }</pre></div>
...
<code>ModifierContext</code>.</p>
  ...
  <span class="hljs-keyword">static</span> get CATEGORY() { <span class="hljs-keyword">return</span> <span class="hljs-string">'accidentals'</span>; }</pre></div>
    ...
    <span class="hljs-keyword">const</span> leftShift = state.left_shift;
    <span class="hljs-keyword">const</span> accidentalSpacing = <span class="hljs-number">2</span>;</pre></div>
...
example: <code>#</code>, <code>##</code>, <code>b</code>, <code>n</code>, etc.</p>
    ...
    <span class="hljs-keyword">this</span>.parenRight = <span class="hljs-literal">null</span>;</pre></div>
  ...
  getCategory() { <span class="hljs-keyword">return</span> Accidental.CATEGORY; }</pre></div>
    ...
    <span class="hljs-keyword">this</span>.parenLeft = Flow.accidentalCodes(<span class="hljs-string">'{'</span>);
    <span class="hljs-keyword">this</span>.parenRight = Flow.accidentalCodes(<span class="hljs-string">'}'</span>);
    <span class="hljs-keyword">const</span> widthAdjust = (<span class="hljs-keyword">this</span>.type === <span class="hljs-string">'##'</span> || <span class="hljs-keyword">this</span>.type === <span class="hljs-string">'bb'</span>) ? <span class="hljs-number">6</span> : <span class="hljs-number">4</span>;</pre></div>
        ...
        <p>Make sure <code>width</code> accomodates for parentheses.</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">this</span>.setWidth(
      <span class="hljs-keyword">this</span>.parenLeft.width
      + <span class="hljs-keyword">this</span>.accidental.width
      + <span class="hljs-keyword">this</span>.parenRight.width
      - widthAdjust
    );
    ...
    <span class="hljs-keyword">if</span> (!context) {
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">'NoContext'</span>, <span class="hljs-string">"Can't draw accidental without a context."</span>);
    }
    ...
    <span class="hljs-keyword">let</span> accX = ((start.x + x_shift) - width);
    <span class="hljs-keyword">const</span> accY = start.y + y_shift;
    L(<span class="hljs-string">'Rendering: '</span>, type, accX, accY);

    <span class="hljs-keyword">const</span> renderGlyphToContext = Glyph.renderGlyph.bind(<span class="hljs-literal">null</span>, context);

    <span class="hljs-keyword">if</span> (!cautionary) {</pre></div>
        ...
        <p>Render the accidental alone.</p>
          ...
          <div class='highlight'><pre>      renderGlyphToContext(accX, accY, font_scale, accidental.code);
        ...
        <p>Render the accidental in parentheses.</p>
          ...
          <div class='highlight'><pre>      accX += <span class="hljs-number">3</span>;
      renderGlyphToContext(accX, accY, font_scale, parenLeft.code);
      accX += <span class="hljs-number">2</span>;
      renderGlyphToContext(accX, accY, font_scale, accidental.code);
      accX += accidental.width - <span class="hljs-number">2</span>;
      <span class="hljs-keyword">if</span> (type === <span class="hljs-string">'##'</span> || type === <span class="hljs-string">'bb'</span>) accX -= <span class="hljs-number">2</span>;
