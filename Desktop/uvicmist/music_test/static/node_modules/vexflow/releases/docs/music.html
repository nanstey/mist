...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Music</span> </span>{
  ...
  getIntervalBetween(note1, note2, direction) {
    ...
    <span class="hljs-keyword">let</span> difference;
...
has an <code>F#</code> state.</p>
    ...
    <span class="hljs-keyword">const</span> scale = <span class="hljs-keyword">this</span>.getScaleTones(<span class="hljs-keyword">this</span>.getNoteValue(keySigString), scaleName);
    <span class="hljs-keyword">const</span> noteLocation = Music.root_indices[keySigParts.root];

    <span class="hljs-keyword">const</span> scaleMap = {};
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> i = <span class="hljs-number">0</span>; i &lt; Music.roots.length; ++i) {
      ...
      <span class="hljs-keyword">let</span> noteName = <span class="hljs-keyword">this</span>.getRelativeNoteName(rootName, scale[i]);
