...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Volta</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">StaveModifier</span> </span>{
  ...
  draw(stave, x) {
    ...
    <span class="hljs-keyword">let</span> width = stave.width;
    <span class="hljs-keyword">const</span> top_y = stave.getYForTopText(stave.options.num_lines) + <span class="hljs-keyword">this</span>.y_shift;
    <span class="hljs-keyword">const</span> vert_height = <span class="hljs-number">1.5</span> * stave.options.spacing_between_lines_px;
