...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">TickContext</span> </span>{
  ...
  getCenterAlignedTickables() {
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.tickables.filter(tickable =&gt; tickable.isCenterAligned());
  }</pre></div>
  ...
  setCurrentTick(tick) {
    ...
    <span class="hljs-keyword">let</span> left_shift = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">let</span> right_shift = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">let</span> extraLeftPx = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">let</span> extraRightPx = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-keyword">this</span>.tickables.length; i++) {
      ...
      <span class="hljs-keyword">const</span> mContext = <span class="hljs-keyword">this</span>.tickables[i].modifierContext;
