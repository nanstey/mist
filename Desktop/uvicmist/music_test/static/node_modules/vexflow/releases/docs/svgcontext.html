...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">SVGContext</span> </span>{
  ...
  closeGroup() {
    <span class="hljs-keyword">const</span> group = <span class="hljs-keyword">this</span>.groups.pop();
...
for us to eventually move in that direction.</p>
  ...
  applyAttributes(element, attributes) {
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">const</span> propertyName <span class="hljs-keyword">in</span> attributes) {
