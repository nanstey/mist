...
optionally set the <code>dash</code> pattern by passing in an array of numbers</p>
    ...
    <span class="hljs-keyword">switch</span> (<span class="hljs-keyword">this</span>.position) {
      ...
      <span class="hljs-keyword">case</span> TextBracket.Positions.BOTTOM:
        ...
        <p>Get the preliminary start and stop coordintates for the bracket</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">const</span> start = { x: <span class="hljs-keyword">this</span>.start.getAbsoluteX(), y };
    <span class="hljs-keyword">const</span> stop = { x: <span class="hljs-keyword">this</span>.stop.getAbsoluteX(), y };
    ...
    <span class="hljs-keyword">const</span> end_x = stop.x + <span class="hljs-keyword">this</span>.stop.getGlyph().head_width;</pre></div>
