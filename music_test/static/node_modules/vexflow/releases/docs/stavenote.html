...
<span class="hljs-keyword">import</span> { Glyph } <span class="hljs-keyword">from</span> <span class="hljs-string">'./glyph'</span>;</pre></div>
        ...
        <p>To enable logging for this class. Set <code>Vex.Flow.StaveNote.DEBUG</code> to <code>true</code>.</p>
          ...
          <div class='highlight'><pre><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">L</span>(<span class="hljs-params">...args</span>) </span>{ <span class="hljs-keyword">if</span> (StaveNote.DEBUG) Vex.L(<span class="hljs-string">'Vex.Flow.StaveNote'</span>, args); }</pre></div>
...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">StaveNote</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">StemmableNote</span> </span>{
  ...
  <span class="hljs-keyword">static</span> get STEM_DOWN() { <span class="hljs-keyword">return</span> Stem.DOWN; }</pre></div>
...
use with care.</p>
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> i = <span class="hljs-number">0</span>; i &lt; notes.length - <span class="hljs-number">1</span>; i++) {
      ...
      <span class="hljs-keyword">const</span> topY = topNote.getStave().getYForLine(topKeys[<span class="hljs-number">0</span>].line);
      <span class="hljs-keyword">const</span> bottomY = bottomNote.getStave().getYForLine(bottomKeys[bottomKeys.length - <span class="hljs-number">1</span>].line);

      <span class="hljs-keyword">const</span> lineSpace = topNote.getStave().options.spacing_between_lines_px;
      <span class="hljs-keyword">if</span> (<span class="hljs-built_in">Math</span>.abs(topY - bottomY) === lineSpace / <span class="hljs-number">2</span>) {
  ...
  getCategory() { <span class="hljs-keyword">return</span> StaveNote.CATEGORY; }</pre></div>
    ...
    <span class="hljs-keyword">const</span> stem = <span class="hljs-keyword">new</span> Stem({ yExtend });
...
displaced as well, for modifier placement</p>
      ...
      <span class="hljs-keyword">this</span>.keyProps.push(props);
        ...
        <p>Sort the notes from lowest line to highest line</p>
          ...
          <div class='highlight'><pre>    lastLine = <span class="hljs-number">-1000</span>;
...
if the note is displaced.</p>
    ...
    <span class="hljs-keyword">this</span>.setExtraLeftPx(
      <span class="hljs-keyword">this</span>.displaced &amp;&amp; <span class="hljs-keyword">this</span>.stem_direction === Stem.DOWN
        ? <span class="hljs-keyword">this</span>.glyph.head_width
...
up by the flag.</p>
    ...
    <span class="hljs-keyword">let</span> width = <span class="hljs-keyword">this</span>.glyph.head_width + <span class="hljs-keyword">this</span>.extraLeftPx + <span class="hljs-keyword">this</span>.extraRightPx;</pre></div>
    ...
    <span class="hljs-keyword">return</span> xBegin + <span class="hljs-keyword">this</span>.glyph.head_width - (Flow.STEM_WIDTH / <span class="hljs-number">2</span>);
  }</pre></div>
    ...
    <span class="hljs-keyword">const</span> drawLedgerLine = (y) =&gt; {
      ...
      <span class="hljs-keyword">const</span> length = ((headX + glyph.head_width) - headX) + (stroke_px * <span class="hljs-number">2</span>);
    ...
    <span class="hljs-keyword">if</span> (glyph.flag &amp;&amp; shouldRenderFlag) {
      <span class="hljs-keyword">let</span> flagX;
      <span class="hljs-keyword">let</span> flagY;
      <span class="hljs-keyword">let</span> flagCode;

      <span class="hljs-keyword">const</span> xBegin = <span class="hljs-keyword">this</span>.getNoteHeadBeginX();
      <span class="hljs-keyword">const</span> xEnd = <span class="hljs-keyword">this</span>.getNoteHeadEndX();
      <span class="hljs-keyword">const</span> { y_top, y_bottom } = <span class="hljs-keyword">this</span>.getNoteHeadBounds();
      ...
      <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.getStemDirection() === Stem.DOWN) {</pre></div>
        ...
        <p>Down stems have flags on the left.</p>
          ...
          <div class='highlight'><pre>        flagX = xBegin + <span class="hljs-number">1</span>;
        flagY = y_top - noteStemHeight + <span class="hljs-number">2</span>;
        ...
        <p>Up stems have flags on the left.</p>
          ...
          <div class='highlight'><pre>        flagX = xEnd + <span class="hljs-number">1</span>;
        flagY = y_bottom - noteStemHeight - <span class="hljs-number">2</span>;
    ...
    <span class="hljs-keyword">const</span> shouldRenderStem = <span class="hljs-keyword">this</span>.hasStem() &amp;&amp; !<span class="hljs-keyword">this</span>.beam;</pre></div>
        ...
        <p>Format stem x positions</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">this</span>.stem.setNoteHeadXBounds(xBegin, xEnd);
