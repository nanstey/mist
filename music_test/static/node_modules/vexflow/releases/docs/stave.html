...
this.modifiers[1].setX(this.end_x);</p>
  ...
  getYForLine(line) {
    ...
    <span class="hljs-keyword">const</span> y = <span class="hljs-keyword">this</span>.y + ((line * spacing) + (headroom * spacing)) - (THICKNESS / <span class="hljs-number">2</span>);
...
getYForLine until the right value is reaches</p>
  ...
  getModifiers(position, category) {
    ...
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.modifiers.filter(modifier =&gt;
  ...
  draw() {
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.context) {
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">'NoCanvasContext'</span>, <span class="hljs-string">"Can't draw stave without canvas context."</span>);
    }
